...
then:-
    ...
    For use with Cluster run the following on each type:-
        ...
        --layers=Number_of_layers --neurons=Number_of_neurons
...
tf.app.flags.DEFINE_integer(
    "layers", 1, "Number of Layers in Neural Network")
tf.app.flags.DEFINE_integer(
    "neurons", 9, "Number of Neurons per layer in Neural Network")
tf.app.flags.DEFINE_string(
    "activation", "tanh", "Activation Function used in Neural Network")
FLAGS = tf.app.flags.FLAGS

""" Number of Layers """
layers_number = FLAGS.layers

""" Number of Neurons """
neurons_layer = FLAGS.neurons
