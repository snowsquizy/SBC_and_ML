...
% Variables
file_name = '8log_a.dat';
delimiter_inline = ',';
layer_1 = importdata(file_name,delimiter_inline);
...
for i = 1:length(layer1)
    if neurons(count1) == layer1(i,4)
        t_sum(count2) = layer1(i,5); 
        count2 = count2 + 1;
    else
...
title('Activation vs Neurons - 1 Layer');
